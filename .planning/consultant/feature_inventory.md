...
| Phase 6 verifier + Stripe UAT checklist | 6 | Hardening - ship-prep / hosted secret gate | Operator/system | Defensive | Medium | Low | Plan 06-06 verifier wiring is complete locally: `verify:phase-6`, schema/artifact gates, hosted workflow, and masked UAT checklist exist. Local `pnpm db:verify`, `pnpm verify:phase-6`, and UAT rows 1-11 PASS; hosted `Verify Phase 6` stays fail-closed until Matthew/operator configures required repo secrets after the SF-WHSEC-1 rotation decision. |
