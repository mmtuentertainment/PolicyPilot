...
| R-004 | Stripe billing implementation misses renewal/failure/cancel/update events or idempotency. | Revenue/Ops | 3 | 5 | 15 | Controlled/Active | Plans 06-01 through 06-03 are complete locally: foundation schema/helpers, 5-event webhook with canonical re-fetch + transaction-scoped idempotency, and real `maxUsers` tier predicate. Score stays 15 until checkout/portal and Stripe test-clock UAT prove the full billing loop (ROADMAP SC#3 / section 10 #6). |
