...
| R-004 | Stripe billing implementation misses renewal/failure/cancel/update events or idempotency. | Revenue/Ops | 1 | 5 | 5 | Controlled/Ship-prep green | Plans 06-01 through 06-06 are complete and verifier-green; live Stripe test-mode UAT rows 1-11 PASS, including true test-clock renewal and first-failure `past_due` proof. Hosted PR #32 checks are green/acceptable at `fe60709`; remaining control is Matthew's ship decision. |
